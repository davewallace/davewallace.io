...
<template>
  <div class="sortable-grid__root">
    ...
    <ul class="sortable-grid__grid">
      <li class="sortable-grid__grid-item" v-for="portfolioItem in allPortfolioItems" v-bind:key="portfolioItem.name">
        <PortfolioItem class="sortable-grid__grid-link"
...
import SortableGridMenu from '@/components/portfolio/SortableGridMenu'
